...
import static com.android.potlach.security.GeneralPotlachAccount.*;
import static android.accounts.AccountManager.KEY_BOOLEAN_RESULT;

/**
 * Created by diyanfilipov on 10/29/14.
 */
public class PotlachAuthenticator extends AbstractAccountAuthenticator{
    private String TAG = PotlachAuthenticator.class.getSimpleName();

    private final Context mContext;

    public PotlachAuthenticator(Context context) {
        super(context);
        // I hate you! Google - set mContext
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response,
        ...
        // return an error
        if (!authTokenType.equals(GeneralPotlachAccount.AUTH_TOKEN_TYPE_READ_ONLY) &&
                !authTokenType.equals(GeneralPotlachAccount.AUTH_TOKEN_TYPE_FULL_ACCESS)) {
