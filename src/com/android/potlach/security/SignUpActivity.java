...
import static com.android.potlach.security.SignInActivity.*;
...
//            String accountName = ((TextView) findViewById(R.id.accountName)).getText().toString().trim();
            ...
            protected Intent doInBackground(String... params) {
                ...
                try {
                    authtoken = sServerAuthenticate.userSignUp(name, "", accountPassword, GeneralPotlachAccount.AUTH_TOKEN_TYPE_FULL_ACCESS);
