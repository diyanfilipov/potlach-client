...
public class SecuredRestBuilder extends RestAdapter.Builder {
	...
	private class OAuthHandler implements RequestInterceptor {
        ...
        private PotlachServerRequestResult requestResult;


		public OAuthHandler(Client client, String tokenIssuingEndpoint, String username,
				String password, String clientId, String clientSecret, PotlachServerRequestResult requestResult) {
			super();
			this.client = client;
		...
		public void intercept(RequestFacade request) {
            ...
            if(requestResult != null) {
                requestResult.setAccessToken(accessToken);
                requestResult.setLoggedIn(loggedIn);
            }
		}
	}
    ...
    public SecuredRestBuilder setOAuthRequestResult(PotlachServerRequestResult requestResult){
        this.requestResult = requestResult;
        return this;
    }
	...
	public RestAdapter build() {
		...
		OAuthHandler hdlr = new OAuthHandler(client, loginUrl, username, password, clientId, clientSecret, requestResult);
